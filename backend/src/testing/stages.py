...
_register(
    StageSpec(
        ...
        tool="ranking",
        name="Folder Scan",
        description="Identifies a clip by content hash and reads its duration, the same way adding it to a folder library would — without actually writing to a folder.",
        external_service=None,
...
_register(
    StageSpec(
        ...
        tool="ranking",
        name="Text Memory",
        description="How editing a ranking input's text also updates (or doesn't) that clip's saved text in the folder library it came from.",
        external_service=None,
